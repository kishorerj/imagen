...
checker_agent_instance = Agent(
    ...
    instruction="Use the 'check_condition_and_escalate_tool' to evaluate if the loop should continue. Once the job is complete, you have to strictly stop the execution of agents.",
